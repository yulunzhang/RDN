...
cmd:text()
cmd:text('Options:')
--cmd:option('-apath',        '/media/kongyu/Black6TB/yulunzhang/data',     'Absolute path of the DIV2K folder')
cmd:option('-apath',        './',     'Absolute path of the DIV2K folder')
cmd:option('-dataset',      'DIV2K',                'Dataset to convert: DIV2K | Flickr2K | DIV2KDRF | RGB291x2')
cmd:option('-scale',        '2_3_4',                'Scales to pack, 2_3_4')
