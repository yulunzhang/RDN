...
%record_results_txt = ['PSNR_SSIM_Results_RDN_RDNplus_', degradation,'_model_x8_DIVFlickr2K.txt'];
record_results_txt = ['PSNR_SSIM_Results_RDNplus_M1040_', degradation,'_model_x8_DIVFlickr2K.txt'];
